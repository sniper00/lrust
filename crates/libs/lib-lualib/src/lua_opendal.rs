...
extern "C-unwind" fn operator_new(state: LuaState) -> i32 {
...
extern "C-unwind" fn operators(state: LuaState) -> i32 {
...
pub unsafe extern "C-unwind" fn luaopen_rust_opendal(state: LuaState) -> i32 {
