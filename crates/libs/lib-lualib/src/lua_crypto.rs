...
extern "C-unwind" fn aes_encrypt(state: LuaState) -> i32 {
...
fn aes_decrypt_imp(state: LuaState) -> Result<i32> {
...
extern "C-unwind" fn aes_decrypt(state: LuaState) -> i32 {
...
/// Returns: key (string)
extern "C-unwind" fn generate_key(state: LuaState) -> i32 {
...
extern "C-unwind" fn generate_nonce(state: LuaState) -> i32 {
    let rng = SystemRandom::new();
